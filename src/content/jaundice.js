export const JAUNDICE_TOPIC = {
  ...
  contentVersion: 'CN-JAUNDICE-PROTOTYPE-0.1',
  reviewedAt: null,
  summary: '黄疸是皮肤或眼白发黄的表现。本原型只解释位置和过程，不判断宝宝的胆红素水平或病情。',
  summaryEn: 'Jaundice is a yellow color change of the skin or sclera. This prototype explains location and process without judging bilirubin levels or illness.',
  steps: [
    { id: 'normal', title: '正常外观', titleEn: 'Normal appearance', eyebrow: '第 1 步', description: '先建立正常结构参照。屏幕颜色不能替代专业测量。', descriptionEn: 'Build a neutral visual reference. Screen color cannot replace a professional measurement.' },
    { id: 'surface', title: '皮肤与巩膜', titleEn: 'Skin and sclera', eyebrow: '第 2 步', description: '认识家长可能观察到发黄的位置，不按颜色深浅判断数值。', descriptionEn: 'Notice possible observation locations without grading color depth.' },
