...
const CONTEXTUAL_FOLLOW_UP_PATTERN = /^(?:\d{1,3}(?:[.,]\d+)?\s*(?:℃|度|°?c|℉|°?f|毫升|ml|次(?:\/分)?|分钟|小时|天|kg|克|斤|厘米|cm)?|是|否|有|没有|不确定|不知道|正常|异常|清醒|容易唤醒|容易叫醒|能叫醒|难唤醒|呼吸平稳|呼吸费力|仰卧|侧睡|趴睡|腋温|腋下|肛温|直肠|耳温|额温|第一天|第二天|第三天|亲喂|母乳|瓶喂)(?:[，。！？.!?\s].*)?$/i
