...
import { CalendarDays, Droplets, Edit3, Info, Save, Trash2, Utensils, X } from 'lucide-react'
...
export function DailyCareTimeline({ events = [], locale = 'zh-CN', selectedDay = localDayKey(), filter = '', onDayChange, onFilterChange, onDetail, onEdit, onVoid, readOnly = false }) {
  const isEnglish = locale === 'en-US'
