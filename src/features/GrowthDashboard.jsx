...
function GrowthOverview({ locale, stage, ageContext, content, metricCards, dataIssues, milestones, adminTasks, onAdminTaskUpdate, readOnly, calendarEvents, onRecord, onOpenRecord, onOpenChart, onOpenStage, onOpenHistory }) {
  const isEnglish = locale === 'en-US'
