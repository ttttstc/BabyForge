  ...
  return (
    <main className="app-shell growth-dashboard-shell">
      ...
      <div className="growth-page">
        ...
        {chartRoute ? <GrowthChartPage locale={locale} baby={state.baby} measurements={state.growthMeasurements} metric={activeMetric} visibleMetrics={visibleMetrics} onMetricChange={setMetric} /> : stageRoute ? <GrowthStagePage locale={locale} stage={stage} ageContext={ageContext} content={content} parentActions={parentActions} onOpenRecord={() => openRecord('care')} /> : historyRoute ? <GrowthHistoryPage locale={locale} evaluations={evaluations} onRecord={() => openRecord('growth')} /> : <GrowthOverview locale={locale} metricCards={metricCards} activeMetric={activeMetric} measurements={state.growthMeasurements} evaluations={evaluations} baby={state.baby} summary={deterministicSummary} parentActions={parentActions} onOpenRecord={() => openRecord('care')} onRecord={() => openRecord('growth')} onOpenChart={openChart} onOpenStage={() => navigate(ROUTES.growthStage)} onOpenHistory={() => navigate(ROUTES.growthHistory)} onOpenAi={() => setAiOpen(true)} />}
      </div>
...
function GrowthOverview({ locale, metricCards, activeMetric, baby, measurements, evaluations, summary, parentActions, onOpenRecord, onRecord, onOpenChart, onOpenStage, onOpenHistory, onOpenAi }) {
  const isEnglish = locale === 'en-US'
  return <div className="growth-overview growth-dashboard-order">
    ...
    <RecentGrowthRecords locale={locale} evaluations={evaluations} onOpenHistory={onOpenHistory} />
  </div>
}
