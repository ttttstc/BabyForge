...
export function QuickRecordPanel({ baby = null, locale = 'zh-CN', onRecord, onConcern, readOnly = false, includeDiapers = true }) {
  ...
  const visibleRecords = includeDiapers ? RECORDS : RECORDS.filter((item) => item.type !== 'diaper')
