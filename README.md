...
BabyForge 是一个面向出生后 0–28 天家庭的 2D/3D 新生儿照护工作台。当前版本支持：建档、阶段里程碑、常见儿科病结构与照护信息、出生与成长测量、观察事实记录、就医沟通摘要。
...
成长测量会保留指标、单位、测量日期、记录来源、测量方式、年龄口径、输入记录 ID、评估时间和标准版本。出生记录使用国家卫生健康委 WS/T 800—2022（24–42 周单胎），出生后整月参考使用 WS/T 423—2022（未满 84 月龄）；数据不足、超出标准范围或多胎出生记录会明确显示限制，不伪造趋势或参考位置。
