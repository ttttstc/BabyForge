...
打开终端显示的本地地址。Vite 开发环境内置隔离演示登录，不需要配置 D1、R2 或模型服务：

- 账号：`demo`
- 密码：`123456`
- 边界：仅使用浏览器内虚构数据；不访问生产 D1、R2、邮件、Google 或 AI Secret，刷新页面即重置。

## 演示用例数据

使用 `demo / 123456` 登录后，可按下面这份虚构档案浏览产品能力。数据仅用于界面展示，不代表真实医疗建议，也不包含真实家庭信息：
