...
3. 家长在今天页中央看到宝宝相册，右侧仍保留当前阶段、今日照护动作和记录入口；未上传照片时显示默认宝宝插画。
...
| `#/today` | 今天 / 宝宝相册 | 主照片、书架缩略图、当前阶段照护动作和主题入口 |
| `#/stage/newborn` | 成长阶段 | 里程碑、日历、代办和成长事实 |
| `#/topic/pediatric-diseases` | 常见儿科病 | 疾病速查、器官学习、3D 展示单元和双语完整指导 |
...
按新生儿、呼吸、传染病、耳鼻喉、消化、皮肤、眼部、泌尿、神经和营养组织 0–6 岁高频 `DiseaseTopic`。疾病分类和器官学习入口共享同一主题；每个主题包含位置、机制、症状、病程、家庭观察、一般处理、就医准备、来源审核和一个或多个 3D 展示单元。3D 缺失或加载失败时显示统一缺省态，完整指导不受影响。
